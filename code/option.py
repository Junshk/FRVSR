...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home//',
                    help='dataset directory')
parser.add_argument('--dir_test', type=str, default='/home//',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='/home//220.mp4',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='FINAL',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='FINAL',
...
parser.add_argument('--save_dir', type=str, default='/home/hosan/Dropbox/data/FRVSR/',
                    help='file name to save')
...
# args = parser.parse_args(re.sub(r"\n", r"\t", r"""
# --test_only --data_test video
# --resume -1 --load test
# --dir_demo C:\Dropbox\data\sr1901\hodoo_test\SD\1_0.mp4
# --save_dir C:\Dropbox\data\sr1901\hodoo_test\SD
# --save 1_0.out.mp4
# """).split())
